<script lang="ts">
	...
	// use them as refs
	let openMenuButton: IconButton; //HTMLButtonElement;
	let closeMenuButton: IconButton; //HTMLButtonElement;
	let lastFocusableElement: HTMLAnchorElement; // Focus Trap

	// icon using component icon
